...
const int TAG_FUNC_CLRD_TO_LAND = 114;
const int TAG_FUNC_MISSED_APP = 115;
const int TAG_FUNC_STAND_AUTO = 116;

const COLORREF TAG_COLOR_DEFAULT_GRAY = RGB(135, 128, 118);
const COLORREF TAG_COLOR_RED = RGB(255, 9, 9);
...
const COLORREF TAG_COLOR_PURPLE = RGB(219, 163, 250);
const COLORREF TAG_COLOR_WHITE = RGB(255, 255, 255);
const COLORREF TAG_COLOR_DARKGREY = RGB(135, 128, 118);
const COLORREF TAG_COLOR_YELLOW = RGB(255, 201, 14);
